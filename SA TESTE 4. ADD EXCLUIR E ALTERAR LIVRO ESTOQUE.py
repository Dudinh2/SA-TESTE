#ALTERAÇÕES REALIZADAS: ADICIONADO BOTÕES PARA VOLTAR, ARRUMADO A TELA DE CADASTRO DE FUNCIONARIO (A VARIAVEL QUE ESTAVA NO BANCO data_entr, 
#NO CODIGO ESTAVA COMO data_entrada, SENDO ASSIM FEITO A ALTERAÇÃO PARA A VARIAVEL DO BANCO.
...
def tela_menu():
    ...
    tk.Button(
        menu, text="Voltar ⬅️", font=("Arial", 12, "bold"), bg="#b57b50", fg="white", command= criar_tela_pesquisa
    ).pack(pady=10)
...
def salvar_cadastro():
    global nomes, telefone, email, cargo, CEP, LOGIN, senha, data_entr  # Declarar as variáveis como globais
...
def tela_funcionario():
    ...
    tk.Button(
        c, text="Voltar ⬅️", font=("Arial", 12, "bold"), bg="#b57b50", fg="white", command=tela_menu
    ).pack(pady=10)
...
##___________________ EXCLUIR E AlTERAR⬆️ ________________________________________________________________________________________________________________________________________________
...
#___________________EXCLUIR E AlTERAR ESTOQUE ⬆️ ________________________________________________________________________________________________________________________________________________
...
def tela_consulta_estoque():
    ...
    tk.Button(
        p, text="Voltar ⬅️", font=("Arial", 12, "bold"), bg="#b57b50", fg="white", command=tela_menu
    ).pack(pady=10)
