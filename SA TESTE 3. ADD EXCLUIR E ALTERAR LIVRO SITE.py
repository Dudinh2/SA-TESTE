...
##___________________ EXCLUIR E AUTERAR⬆️ ________________________________________________________________________________________________________________________________________________
...
def cadastrar_livros_es():
    ...
    tk.Button(
        ca, text="Voltar ⬅️", font=("Arial", 12, "bold"), bg="#b57b50", fg="white", command=tela_menu
    ).pack(pady=10)
